...
class SiteController extends Controller
{
    ...
    public function product($slug)
    {
        ...
        return view('frontend/product', compact('product', 'related_product', 'colors', 'sizes', 'reviews', 'review_create', 'buy'));
    }

    public function is_buy($product): bool
    {
    ...
    public function review_create($product): bool
    {
        $customer = session('customer_id');
        if ($customer) {
            return !(bool)ItemsReview::where('customer_id', $customer)->where('product_id', $product)->get();
        } else {
            return false;
        }
    }
