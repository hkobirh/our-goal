            ...
            <div class="col-lg-9">
                    ...
                    <div class="home-slide home-slide1 banner banner-md-vw banner-sm-vw">
                        ...
                        <div class="banner-layer banner-layer-middle">
                            ...
                            <h5 class="text-white text-uppercase d-inline-block mb-0 ls-n-20 align-text-bottom">Starting
                                At <b class="coupon-sale-text bg-secondary text-white d-inline-block">$<em
                ...
                <div class="products-slider owl-carousel owl-theme dots-top m-b-1 pb-1">
                    @foreach($featured as $featured_item)
                        @php($s_price = false)
                        @if($featured_item->special_price_from <= date('Y-m-d') && $featured_item->special_price_to >= date('Y-m-d'))
                            @php($s_price = true)
                        @endif
                        <div class="product-default inner-quickview inner-icon">
                            <figure>
                                <a href="{{route('product.quick.view',$featured_item->slug)}}">
                                    <img src="{{asset('uploads/'.$featured_item->thumbnail)}}">
                                </a>
                                <div class="label-group">
                                    <div class="product-label label-hot">HOT</div>
                                </div>
                                <div class="btn-icon-group">
                                    <button class="btn-icon btn-add-cart add-to-cart" data-id="{{$featured_item->id}}"><i class="icon-shopping-cart"></i></button>

                                </div>
                                <a href="{{route('product.quick.view',$featured_item->slug)}}" class="btn-quickview" title="Quick View">Quick
                                    View</a>
                            </figure>
                            <div class="product-details">
                                <div class="category-wrap">
                                    <div class="category-list">
                                        <a href="{{$featured_item->slug}}" class="product-category">category</a>
                                    </div>
                                    <a href="#" class="btn-icon-wish"><i class="icon-heart"></i></a>
                                </div>
                                <h2 class="product-title">
                                    <a href="product.html">{{$featured_item->name}}</a>
                                </h2>
                                ...
                                <div class="price-box">
                                    @if($s_price)
                                        ...
                                        <span class="product-price">{{$featured_item->special_price}}</span>
                                    @else
                                        <span class="product-price">{{$featured_item->selling_price}}</span>
                                    @endif
                                </div><!-- End .price-box -->
                ...
                <div class="brands-slider owl-carousel owl-theme images-center mb-3" data-owl-options="{
                    ...
                    <img src="{{asset('theme/frontend/assets/images/brands/brand1.png')}}" width="140" height="60"
                         alt="brand">
                    <img src="{{asset('theme/frontend/assets/images/brands/brand2.png')}}" width="140" height="60"
                         alt="brand">
                    <img src="{{asset('theme/frontend/assets/images/brands/brand3.png')}}" width="140" height="60"
                         alt="brand">
                    <img src="{{asset('theme/frontend/assets/images/brands/brand4.png')}}" width="140" height="60"
                         alt="brand">
                    <img src="{{asset('theme/frontend/assets/images/brands/brand5.png')}}" width="140" height="60"
                         alt="brand">
                    <img src="{{asset('theme/frontend/assets/images/brands/brand6.png')}}" width="140" height="60"
                         alt="brand">
                        ...
                        <div class="product-column">
                            ...
                            <div class="product-default left-details product-widget mb-3">
                                <figure>
                                    <a href="product.html">
                                        <img
                                            src="{{asset('theme/frontend/assets/images/products/home-featured-3.jpg')}}">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                            ...
                            <div class="product-default left-details product-widget mb-3">
                                <figure>
                                    <a href="product.html">
                                        <img
                                            src="{{asset('theme/frontend/assets/images/products/home-featured-4.jpg')}}">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                            ...
                            <div class="product-default left-details product-widget mb-3">
                                <figure>
                                    <a href="product.html">
                                        <img
                                            src="{{asset('theme/frontend/assets/images/products/small/product-1.jpg')}}">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                        ...
                        <div class="product-column">
                            ...
                            <div class="product-default left-details product-widget mb-3">
                                <figure>
                                    <a href="product.html">
                                        <img
                                            src="{{asset('theme/frontend/assets/images/products/home-featured-1.jpg')}}">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                            ...
                            <div class="product-default left-details product-widget mb-3">
                                <figure>
                                    <a href="product.html">
                                        <img
                                            src="{{asset('theme/frontend/assets/images/products/home-featured-2.jpg')}}">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                            ...
                            <div class="product-default left-details product-widget mb-3">
                                <figure>
                                    <a href="product.html">
                                        <img
                                            src="{{asset('theme/frontend/assets/images/products/home-featured-5.jpg')}}">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                    ...
                    <div class="owl-carousel owl-theme dots-left">
                        <div class="testimonial">
                            <div class="testimonial-owner">
                                <figure>
                                    <img src="{{asset('theme/frontend/assets/images/clients/client-1.jpg')}}"
                                         alt="client">
                                </figure>
                        ...
                        <div class="testimonial">
                            <div class="testimonial-owner">
                                <figure>
                                    <img src="{{asset('theme/frontend/assets/images/clients/client-2.jpg')}}"
                                         alt="client">
                                </figure>
                        ...
                        <div class="testimonial">
                            <div class="testimonial-owner">
                                <figure>
                                    <img src="{{asset('theme/frontend/assets/images/clients/client-3.jpg')}}"
                                         alt="client">
                                </figure>
                    ...
                    <div class="owl-carousel owl-theme dots-left dots-m-0" data-owl-options="{
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="single.html">
                                    <img src="{{asset('theme/frontend/assets/images/blog/home/post-1.jpg')}}"
                                         alt="Post">
                                </a>
                                <div class="post-date">
                            ...
                            <div class="post-body">
                                ...
                                <div class="post-content">
                                    <p>Euismod atras vulputate iltricies etri elit. Class aptent taciti sociosqu ad
                                        litora torquent per conubia nostra, per incep tos himens.</p>
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="single.html">
                                    <img src="{{asset('theme/frontend/assets/images/blog/home/post-2.jpg')}}"
                                         alt="Post">
                                </a>
                                <div class="post-date">
                                    <span class="day">29</span>
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="single.html">
                                    <img src="{{asset('theme/frontend/assets/images/blog/home/post-3.jpg')}}"
                                         alt="Post">
                                </a>
                                <div class="post-date">
                                    <span class="day">29</span>
