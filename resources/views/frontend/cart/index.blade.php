                            ...
                            <td class="product-col">
                                <figure class="product-image-container">
                                    <a href="product.html" class="product-image">
                                        <img style="width: 50px" src="{{$items->attributes->image}}" alt="product">
                                    </a>
                                </figure>
                                <h4 class="product-title">
                                    <a target="_blank" href="{{route('product',$items->attributes->slug)}}">{{$items->name}}</a>
                                </h4>
                            </td>
                            <td>{{$items->price}}</td>
                            <td>
                                <form action="{{route('cart.update',$items->id)}}" method="post">
                                    @csrf
                                    <input class="vertical-quantity form-control" name="quantity" type="text" value="{{$items->quantity}}">
                                    <button type="submit">Update</button>
                                </form>
                            </td>
                            <td>{{$items->price * $items->quantity}}</td>
                            <td>
                                <a href="{{route('cart.remove',$items->id)}}">Remove</a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
