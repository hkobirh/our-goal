                            ...
                            <div id="specialoffershow" style="display: none">
                                <div class=" form-row ">
                                    ...
                                    <div class="form-group col-md-4 ">
                                        ...
                                        <input type="text" class="input form-control" name="special_p_from" placeholder="dd-mm-yyyy"  pattern="(?:30))|(?:(?:0[13578]|1[02])-31))/(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])/(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])">
                                    </div>
                                    <div class="form-group col-md-4 ">
                                        <label>Special Price To</label>
                                        <input type="text" class="input form-control" name="special_p_to" placeholder="dd-mm-yyyy"  pattern="(?:30))|(?:(?:0[13578]|1[02])-31))/(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])/(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])">
                                    </div>
                                </div>
                            </div>
                            <div class=" form-row ">
